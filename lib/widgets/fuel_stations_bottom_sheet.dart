...
class FuelStationsBottomSheet extends StatefulWidget {
  ...
  @override
  _FuelStationsBottomSheetState createState() => _FuelStationsBottomSheetState();
}
    ...
    return SnappingSheet(
      ...
      grabbing: Container(
        ...
        child: SizedBox(height: 100, width: 100, child: SearchBar(searchOnTap: () {
          ...
          snappingSheetController.snapToPosition(const SnappingPosition.factor(positionFactor: 0.7)).then((value) {
