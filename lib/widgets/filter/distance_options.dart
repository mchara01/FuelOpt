    ...
    return Stack(
      children: [
        ...
        Align(
          ...
          child: IconButton(onPressed: widget.onTapClose, icon: Container(decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white),child: Icon(Icons.close, color: Theme.of(context).primaryColor,))),
        )
    ]
    );
  }
