              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                      ...
                      onPressed: Provider.of<SearchQueryModel>(context)
                              .searchQuery
                              .isEmpty
                          ? null
                          : () async {
                              final currentSearchQuery =
                                  Provider.of<SearchQueryModel>(context,
                                      listen: false);
                              final sortByPreference =
                                  Provider.of<SortByPreferenceModel>(context,
                                      listen: false);
                              final fuelTypePreference =
                                  Provider.of<FuelTypePreferenceModel>(context,
                                      listen: false);
                              final distancePreference =
                                  Provider.of<DistancePreferenceModel>(context,
                                      listen: false);
                              final facilitiesPreference =
                                  Provider.of<FacilitiesPreferenceModel>(
                                      context,
                                      listen: false);
                              final searchResult =
                                  Provider.of<SearchResultModel>(context,
                                      listen: false);
                              ...
                              if (currentSearchQuery.searchQuery.isEmpty) {
                                ...
                                List coordinates1 = await fuelStationDataService
                                    .address2Coordinates(currentSearchQuery
                                        .searchQuery
                                        .toString());
                                List coordinates2 = await fuelStationDataService
                                    .postcode2Coordinates(currentSearchQuery
                                        .searchQuery
                                        .toString());
                                coordinates = coordinates2.isNotEmpty
                                    ? coordinates2
                                    : coordinates1;
                              }
                              if (coordinates.isEmpty) {
                                ...
                                List<Station> stations =
                                  ...
                                  distancePreference.distancePreference
                                      .toString(),
                                  facilitiesPreference.facilitiesPreference
                                      .toString(),
                                  '',
                                  '',
                                );
                                searchResult.setSearchResult(stations);
                                currentLocation.animateCameraToPosition(LatLng(
