...
class APITests(TestCase):
    ...
    def setUp(self):
        ...
        self.token = json.loads(self.client.post('/apis/token/', {'username': 'testuser', 'password': 'secret'}).content)['token']
    ...
    def test_default(self):
        ...
        c = Client ()
        response = c.get(f'/apis/search', {'user_preference':user_pref, 'location':location, 'fuel_type':fuel_type, 'distance':distance, 'amenities':amenities}, True)
