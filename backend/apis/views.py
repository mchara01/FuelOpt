...
def search(request):
    ...
    if request.method == 'GET':
        ...
        for fuel_price in preferences_list:
            travel_durations[fuel_price.station.pk], travel_traffic_durations[fuel_price.station.pk], travel_distance[
                fuel_price.station.pk] = get_duration_distance(user_lat, user_lng, fuel_price.station.lat,
                                                               fuel_price.station.lng)
        ...
        if user_preference == 'price' or user_preference == '':
            if not fuel_type:
                ...
                for pref in fuel_preference:
                    ...
                    sorted_station_pks = sort_by_price(curr_pref_list, travel_traffic_durations, travel_durations,
                ...
                for fuel, preferences_list in best_station_general.items():
                    ...
                    for fuel_price in preferences_list:
                        ...
                        station_response['duration'] = str(
                            int(travel_traffic_durations[fuel_price.station.pk] / 60)) + 'mins'
                ...
                # Sort stations according to sorted durations
                sorted_station_pks = sort_by_price(preferences_list, travel_traffic_durations, travel_durations,
                                                   travel_distance, preferred_fuel_prices)
